...
if($auth->isAuthorized())
{
	...
	<link rel="stylesheet" href="resources/show-hint.min.css">
	...
	<script src="resources/show-hint.min.js"></script>
		...
		case "row_view":
			...
			if($shownRows>0)
			{
				...
				//- Chart view
				{
					...
					?>
					<script type='text/javascript' src='resources/google.jsapi.js'></script>
					<script type='text/javascript'>
...
class GetParameters
{
	...
	{
		$arg_sep = ($html?'&amp;':'&');
		return URL_PREFIX.$prefix . http_build_query(array_merge($this->_fields, $assoc), '', $arg_sep);
	}
